...
public class ListProductController {
	...
	public ResponseEntity<BaseResponse> get(HttpServletRequest request){
		...
		try {
			List<ListProduct> listProducts = listProductService.findAllListProduct();
			List<Object> listProductResponse = new ArrayList<>();
			for(ListProduct listProduct : listProducts) {
				
				Object data = new Object() {
					public final int id_list_product = listProduct.getId();
					public final String image_list_product = listProduct.getImage_item_list();
					public final String name_list_product = listProduct.getName_item_list();
				};
	...
	@ResponseBody
	@RequestMapping(value = "/getProductDetailByIdListProduct",method = RequestMethod.GET, produces = {MediaType.APPLICATION_JSON_VALUE})
	public ResponseEntity<BaseResponse> getProducDetailByIdList(HttpServletRequest request,
		...
		try {
			...
			List<Integer> listObject = productService.findListIdProductByIdListProduct(listProducts, id_ListProduct);
